...
BINARY="wizard"
INSTALL_DIR="zagrooo-wizard"
ARCHIVE="ZAG-Wizard-${OS_LOWER}-${ARCH}.${EXT}"
WORKER_URL="https://github.com/rexteamiran/ZAG-Panel/releases/latest/download/worker.js"
ARCHIVE_URL="https://github.com/rexteamiran/ZAG-Wizard/releases/latest/download/${ARCHIVE}"

LATEST_VERSION=$(curl -fsSL https://raw.githubusercontent.com/rexteamiran/ZAG-Wizard/main/VERSION)
